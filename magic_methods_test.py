...
"""
import pytest
file/settings/tools biblioteka do testowania (autodetect)
"""

def test_str():  # musi zaczynac sie od test | state testing / behaviour testing
    v = Vector(5, 12)  # arrange / having
    s = str(v)  # act / when
    assert s == '<5,12>'  #  assert / then
